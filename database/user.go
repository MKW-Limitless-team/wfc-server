...
const (
	...
	GetUserProfileID        = `SELECT profile_id, ng_device_id, email, unique_nick, firstname, lastname, open_host, discord_id, last_ip_address, allow_default_keys FROM users WHERE user_id = $1 AND gsbrcd = $2`
